...
<section id="cover" class="fixed inset-0 z-[100] flex items-center justify-center navy-bg transition-opacity duration-1000">
    <div class="absolute inset-0 z-0">
        <img
            src="{{ asset('assets/image/theme-4-cover.jpeg') }}"
                ...
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="order-1 md:order-2 relative" data-aos="fade-left">
                        <div class="relative aspect-[3/4] overflow-hidden rounded-2xl border-4 border-[#d4af37]">
                            <img src="{{ asset('assets/image/theme-4-cover.jpeg') }}" class="w-full h-full object-cover">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex justify-center" data-aos="zoom-in">
                        ...
                        <div class="relative group max-w-md w-full">
                            ...
                            <div class="relative overflow-hidden rounded-3xl aspect-[3/4] shadow-2xl">
                                <img src="{{ asset('assets/image/theme-4-cover.jpeg') }}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                                <!-- Gold Accent Overlay -->
            ...
            <div class="space-y-12 md:space-y-0">
                ...
                <div class="relative flex flex-col md:flex-row items-center justify-between w-full group">
                    <div class="w-full md:w-5/12 md:pr-12 pl-12 md:pl-0 md:text-right mb-6 md:mb-0" data-aos="fade-right">
                        <div class="glass-effect p-6 md:p-8 rounded-tr-3xl rounded-bl-3xl border border-[#d4af37]/10 hover:border-[#d4af37]/30 transition-all duration-500 relative">
                            <div class="absolute top-4 right-4 md:left-auto md:right-auto md:-right-3 w-6 h-6 bg-[#d4af37]/10 rotate-45 transform"></div>
                            <h3 class="font-serif text-xl md:text-2xl text-[#d4af37] italic mb-2">September 2025</h3>
                            <div class="inline-block bg-[#d4af37]/10 text-[#d4af37] text-xs font-bold px-3 py-1 rounded-full mb-4">
                                01
                            </div>
                            <p class="text-[#f7e7ce] font-light leading-relaxed text-sm">
                                Untuk pertama kalinya kedua pihak bertemu. Sebatas pertemuan sederhana nan biasa. Saat nota reimburse diserahkan, pihak laki-laki merasakan debar halus—seolah hatinya mulai diuji.
                            </p>
                        </div>
                    </div>
                    <!-- Center Node -->
                    <div class="absolute left-4 md:left-1/2 transform -translate-x-1/2 flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-full navy-bg border-2 border-[#d4af37] z-10 shadow-lg group-hover:scale-110 transition-transform duration-500">
                ...
                <div class="relative flex flex-col md:flex-row items-center justify-between w-full group md:mt-[-30px]">
                    <div class="w-full md:w-5/12 pr-12 md:pr-12 hidden md:block"></div>
                    <!-- Center Node -->
                    <div class="absolute left-4 md:left-1/2 transform -translate-x-1/2 flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-full navy-bg border-2 border-[#d4af37] z-10 shadow-lg group-hover:scale-110 transition-transform duration-500 bg-[#d4af37]">
                        <span class="w-2 h-2 rounded-full bg-white"></span>
                    </div>
                    <div class="w-full md:w-5/12 pl-12 md:pl-12" data-aos="fade-left">
                         <div class="glass-effect p-6 md:p-8 rounded-tl-3xl rounded-br-3xl border border-[#d4af37]/10 hover:border-[#d4af37]/30 transition-all duration-500 relative">
                             <div class="absolute top-4 -left-3 hidden md:block w-6 h-6 bg-[#d4af37]/10 rotate-45 transform"></div>
                            <h3 class="font-serif text-xl md:text-2xl text-[#d4af37] italic mb-2">Akhir Oktober 2025</h3>
                             <div class="inline-block bg-[#d4af37]/10 text-[#d4af37] text-xs font-bold px-3 py-1 rounded-full mb-4">
                                02
                            </div>
                             <p class="text-[#f7e7ce] font-light leading-relaxed text-sm">
                                Pihak perempuan kembali hadir. Tanpa saling mengenal dan saling mengetahui. Keduanya bertemu dalam sesi foto tim akhwat finance, dengan pihak laki-laki di balik lensa—Hatinya berdebar dan mulai kembali diuji.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex flex-col md:flex-row items-center justify-between w-full group md:mt-[-30px]">
                    <div class="w-full md:w-5/12 md:pr-12 pl-12 md:pl-0 md:text-right mb-6 md:mb-0" data-aos="fade-right">
                        <div class="glass-effect p-6 md:p-8 rounded-tr-3xl rounded-bl-3xl border border-[#d4af37]/10 hover:border-[#d4af37]/30 transition-all duration-500 relative">
                            <div class="absolute top-4 right-4 md:left-auto md:right-auto md:-right-3 w-6 h-6 bg-[#d4af37]/10 rotate-45 transform"></div>
                            <h3 class="font-serif text-xl md:text-2xl text-[#d4af37] italic mb-2">23 November 2025</h3>
                            <div class="inline-block bg-[#d4af37]/10 text-[#d4af37] text-xs font-bold px-3 py-1 rounded-full mb-4">
                                03
                            </div>
                            <p class="text-[#f7e7ce] font-light leading-relaxed text-sm">
                                Sebuah keberanian dilakukan. Ilham melangkah dengan niat lurus, mengajukan ta'aruf kepada Muthia melalui salah satu Asatidz Cinta Quran Foundation.
                            </p>
                        </div>
                    </div>
                    <!-- Center Node -->
                ...
                <div class="relative flex flex-col md:flex-row items-center justify-between w-full group md:mt-[-30px]">
                    ...
                    <div class="w-full md:w-5/12 pl-12 md:pl-12" data-aos="fade-left">
                         <div class="glass-effect p-6 md:p-8 rounded-tl-3xl rounded-br-3xl border border-[#d4af37]/10 hover:border-[#d4af37]/30 transition-all duration-500 relative">
                             <div class="absolute top-4 -left-3 hidden md:block w-6 h-6 bg-[#d4af37]/10 rotate-45 transform"></div>
                            <h3 class="font-serif text-xl md:text-2xl text-[#d4af37] italic mb-2">1 Desember 2025</h3>
                             <div class="inline-block bg-[#d4af37]/10 text-[#d4af37] text-xs font-bold px-3 py-1 rounded-full mb-4">
                                04
                            </div>
                             <p class="text-[#f7e7ce] font-light leading-relaxed text-sm">
                                Di selasar Masjid Raya Al-Muttaqin, Kota Bogor, menjadi awal pertemuan kedua pihak dengan pendampingan dua perantara.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex flex-col md:flex-row items-center justify-between w-full group md:mt-[-30px]">
                    <div class="w-full md:w-5/12 md:pr-12 pl-12 md:pl-0 md:text-right mb-6 md:mb-0" data-aos="fade-right">
                        <div class="glass-effect p-6 md:p-8 rounded-tr-3xl rounded-bl-3xl border border-[#d4af37]/10 hover:border-[#d4af37]/30 transition-all duration-500 relative">
                            <div class="absolute top-4 right-4 md:left-auto md:right-auto md:-right-3 w-6 h-6 bg-[#d4af37]/10 rotate-45 transform"></div>
                            <h3 class="font-serif text-xl md:text-2xl text-[#d4af37] italic mb-2">8 Desember 2025</h3>
                            <div class="inline-block bg-[#d4af37]/10 text-[#d4af37] text-xs font-bold px-3 py-1 rounded-full mb-4">
                                05
                            </div>
                            <p class="text-[#f7e7ce] font-light leading-relaxed text-sm">
                                Pukul 8 malam, sebuah pertemuan bersama orang tua Muthia. 2 jam penuh doa, diskusi dan pertanyaan. Menjadi langkah awal untuk saling meyakinkan niat.
                            </p>
                        </div>
                    </div>
                    <!-- Center Node -->
                    ...
                    <div class="w-full md:w-5/12 pl-12 md:pl-12" data-aos="fade-left">
                         <div class="glass-effect p-6 md:p-8 rounded-tl-3xl rounded-br-3xl border border-[#d4af37]/10 hover:border-[#d4af37]/30 transition-all duration-500 relative">
                            ...
                            <h3 class="font-serif text-xl md:text-2xl text-[#d4af37] italic mb-2">9-26 Desember</h3>
                             ...
                             <p class="text-[#f7e7ce] font-light leading-relaxed text-sm">
                                Hari demi hari penuh pertimbangan. 27 Desember, Ilham kembali diundang untuk diperkenalkan kepada keluarga besar Muthia.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex flex-col md:flex-row items-center justify-between w-full group md:mt-[-30px]">
                    <div class="w-full md:w-5/12 md:pr-12 pl-12 md:pl-0 md:text-right mb-6 md:mb-0" data-aos="fade-right">
                        <div class="glass-effect p-6 md:p-8 rounded-tr-3xl rounded-bl-3xl border border-[#d4af37]/10 hover:border-[#d4af37]/30 transition-all duration-500 relative">
                            <div class="absolute top-4 right-4 md:left-auto md:right-auto md:-right-3 w-6 h-6 bg-[#d4af37]/10 rotate-45 transform"></div>
                            <h3 class="font-serif text-xl md:text-2xl text-[#d4af37] italic mb-2">18 Januari 2026</h3>
                            <div class="inline-block bg-[#d4af37]/10 text-[#d4af37] text-xs font-bold px-3 py-1 rounded-full mb-4">
                                07
                            </div>
                            <p class="text-[#f7e7ce] font-light leading-relaxed text-sm">
                                Atas izin Allah, kedua orang tua kami dipertemukan. Sebuah khitbah menjadi pengikat niat, doa, dan masa depan kami.
                            </p>
                        </div>
                    </div>
                    <!-- Center Node -->
                ...
                <div class="relative flex flex-col md:flex-row items-center justify-between w-full group md:mt-[-30px]">
                    ...
                    <div class="w-full md:w-5/12 pl-12 md:pl-12" data-aos="fade-left">
                         <div class="glass-effect p-6 md:p-8 rounded-tl-3xl rounded-br-3xl border border-[#d4af37]/10 hover:border-[#d4af37]/30 transition-all duration-500 relative">
                             <div class="absolute top-4 -left-3 hidden md:block w-6 h-6 bg-[#d4af37]/10 rotate-45 transform"></div>
                            <h3 class="font-serif text-xl md:text-2xl text-[#d4af37] italic mb-2">Februari-April 2026</h3>
                             <div class="inline-block bg-[#d4af37]/10 text-[#d4af37] text-xs font-bold px-3 py-1 rounded-full mb-4">
                                08
                            </div>
                             <p class="text-[#f7e7ce] font-light leading-relaxed text-sm">
                ...
                <div class="relative flex flex-col md:flex-row items-center justify-between w-full group md:mt-[-30px]">
                    <div class="w-full md:w-5/12 md:pr-12 pl-12 md:pl-0 md:text-right mb-6 md:mb-0" data-aos="fade-right">
                        <div class="glass-effect p-6 md:p-8 rounded-tr-3xl rounded-bl-3xl border border-[#d4af37]/10 hover:border-[#d4af37]/30 transition-all duration-500 relative">
                            ...
                            <p class="text-[#f7e7ce] font-light leading-relaxed text-sm">
                                Salah satu hari dan momen terindah yang terjadi di hidup kami. Ya, hari akad itu dimulai. Insyaallah kami berdua akan melaksanakan "Mitsaqan Ghaliza" (Perjanjian Agung) yang akan mempersatukan tujuan mulia itu.
                            </p>
                        </div>
                    </div>
                    <!-- Center Node -->
        ...
        <div class="container mx-auto max-w-5xl relative z-10">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="glass-effect rounded-xl p-8 text-center" data-aos="fade-up">
                    ...
                    <p class="text-[#f7e7ce] font-light mb-2 tracking-widest uppercase text-xs">BRI</p>
                    <p class="text-[#f7e7ce] font-semibold text-lg mb-4">3263 0102 4309 536</p>
                    <p class="text-[#f7e7ce] text-xs font-light">Atas Nama: ILHAM JAYA KUSUMAH</p>
                    <button class="mt-4 text-[#d4af37] text-[10px] uppercase tracking-widest border border-[#d4af37]/30 px-4 py-1 rounded-full hover:bg-[#d4af37] hover:text-[#001f3f] transition-all">Salin No. Rekening</button>
                </div>
                ...
                <!-- Account 3: Muthia BCA -->
                <div class="glass-effect rounded-xl p-8 text-center" data-aos="fade-up" data-aos-delay="200">
                    <h3 class="text-xl font-serif text-[#d4af37] italic mb-4">Transfer Bank</h3>
                    <p class="text-[#f7e7ce] font-light mb-2 tracking-widest uppercase text-xs">BCA</p>
                    <p class="text-[#f7e7ce] font-semibold text-lg mb-4">0955139921</p>
        ...
        <div class="container mx-auto max-w-6xl relative z-10">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
                ...
                <div class="text-center space-y-4" data-aos="fade-up">
                    ...
                    <p class="text-xs md:text-sm font-semibold uppercase tracking-widest text-[#f7e7ce]">Amalkan sapa & senyum</p>
                </div>
                ...
                <div class="text-center space-y-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="w-20 h-20 mx-auto rounded-full bg-[#d4af37]/10 border-2 border-[#d4af37] flex items-center justify-center group hover:bg-[#d4af37]/20 transition">
                        <svg class="w-10 h-10 text-[#d4af37]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 11.5V14m0-2.5v-6a1.5 1.5 0 113 0V12m-3 .5a3 3 0 006 0V6a1.5 1.5 0 10-3 0v12a3 3 0 11-6 0v-4m.5-3.5h0" />
                        </svg>
                    </div>
                    <p class="text-xs md:text-sm font-semibold uppercase tracking-widest text-[#f7e7ce]">Mendo'akan Keberkahan untuk Pengantin & Keluarga</p>
                </div>
                ...
                <div class="text-center space-y-4" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="text-xs md:text-sm font-semibold uppercase tracking-widest text-[#f7e7ce]">Memperhatikan Adab Makan dan Minum</p>
                </div>
                ...
                <div class="text-center space-y-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="w-20 h-20 mx-auto rounded-full bg-[#d4af37]/10 border-2 border-[#d4af37] flex items-center justify-center group hover:bg-[#d4af37]/20 transition">
                        <svg class="w-10 h-10 text-[#d4af37]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04M12 21.48V11.5" />
                        </svg>
                    </div>
                    <p class="text-xs md:text-sm font-semibold uppercase tracking-widest text-[#f7e7ce]">Berpakaian dengan Rapih dan Sopan</p>
                </div>
                ...
                <div class="text-center space-y-4" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <p class="text-xs md:text-sm font-semibold uppercase tracking-widest text-[#f7e7ce]">Tidak Merokok di Lingkungan Acara</p>
                </div>
    ...
    <footer class="py-16 px-6 relative">
        <div class="container mx-auto max-w-4xl text-center relative z-10" data-aos="fade-up">
            ...
            <div class="flex justify-center gap-6 mb-8">
                ...
                <a href="#" class="text-[#d4af37] hover:text-[#f7e7ce] transition">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M23.953 4.57a10 10 0 002.856-3.51 10 10 0 01-2.956 1.745 4.993 4.993 0 00-8.604 4.585c-4.15-.05-7.9-2.175-10.403-5.174-.433.744-.679 1.61-.679 2.532 0 1.732.886 3.26 2.23 4.152a4.978 4.978 0 01-2.26-.616v.06c0 2.421 1.724 4.438 4.008 4.9a4.977 4.977 0 01-2.252.086c.634 1.953 2.483 3.375 4.666 3.415a10.005 10.005 0 01-6.175 2.13 10 10 0 015.89-1.725c7.068 0 10.928-5.86 10.928-10.93 0-.166-.003-.332-.01-.497a7.793 7.793 0 001.913-1.993z" />
                    </svg>
                </a>
                <a href="#" class="text-[#d4af37] hover:text-[#f7e7ce] transition">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                        <rect x="2" y="2" width="20" height="20" rx="5" ry="5" fill="none" stroke="currentColor" stroke-width="2" />
                        <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z" fill="none" stroke="currentColor" stroke-width="1.5" />
