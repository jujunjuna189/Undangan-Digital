            ...
            <div class="p-6 flex flex-col h-full">
                ...
                <div class="mt-auto space-y-4">
                    ...
                    <form action="{{ route('logout') }}" method="POST" class="px-2">
                        @csrf
                        <button type="submit" class="w-full flex items-center gap-3 px-4 py-3 rounded-2xl text-gray-400 hover:bg-rose-50 hover:text-rose-600 transition group border border-transparent hover:border-rose-100 italic">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path></svg>
                            <span class="text-xs font-bold uppercase tracking-widest">Keluar Akun</span>
                        </button>
                    </form>
                </div>
            </div>
